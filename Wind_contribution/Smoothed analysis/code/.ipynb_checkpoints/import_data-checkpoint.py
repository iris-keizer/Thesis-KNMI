...
def import_obs_slh_data(data_type = 'era5', window = 21):
    """
    ...
    data_df = df_smooth(data_df, window)
...
def import_obs_wind_data(model = 'Nearest Point', data_type = 'era5', window = 21):
    """
    ...
    # Apply lowess filter
    annual_df = df_smooth(annual_df, window)
